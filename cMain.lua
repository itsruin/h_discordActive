...
Citizen.CreateThread(function()
    while true do
        TriggerServerEvent('hybe_discordActive:vRPsyncLoop')
		Wait(5 * 60 * 1000)
	end
end)

RegisterNetEvent('hybe_discordActive:vRPsync')
AddEventHandler('hybe_discordActive:vRPsync', function(name, user_id, faction)
    ...
    Citizen.CreateThread(function()
        ...
        while true do
            ...
            SetDiscordRichPresenceAction(0, "디스코드", "https://discord.gg/link")
            SetDiscordRichPresenceAction(1, "서버접속", "fivem://connect/0.0.0.0:30120")
        end
    end)
end)

print("^3[hybe_discordActive] ^0cMain.lua applyed successfully!")